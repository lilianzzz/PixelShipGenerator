...
class Frame(object):
    ...
    layout = {'rect': (('Long', 'Short'), ),
              ...
              'top_hook': (('Med', 'Squat', 'Top', 'Left'),
                           ('Long', 'Squat', 'Right'),
                           ('Skinny', 'Squat', 'High')),
              'bot_hook': (('Med', 'Squat', 'Bot', 'Left'),
                           ('Long', 'Squat', 'Right'),
                           ('Skinny', 'Squat', 'Low')),
              'hook': (('Med', 'Squat', 'High', 'Left'),
                       ('Med', 'Squat', 'Low', 'Left'),
                       ('Med', 'Squat', 'Right')),
              'top_claw': (('Med', 'Squat', 'Top', 'Left'),
                           ('Med', 'Squat', 'Right'),
                           ('Skinny', 'Squat', 'High')),
              'bot_claw': (('Med', 'Squat', 'Bot', 'Left'),
                           ('Med', 'Squat', 'Right'),
                           ('Skinny', 'Squat', 'Low')),
